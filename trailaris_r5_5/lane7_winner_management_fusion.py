...
def boolcol(z,name):return z[name].astype(bool) if name in z.columns else pd.Series(False,index=z.index)
...
def main():
    ...
    z=causal_decision_features(cands,fcache);qual=rule_mask(z,rule).to_numpy()
