...
def main():
 ...
 checks={
  ...
  'batch_event_drawdown_50_floor_pct':m50['batch_consistent_event_drawdown_pct']>=g['batch_event_drawdown_50_floor_pct'],
  'batch_event_drawdown_relative':m50['batch_consistent_event_drawdown_pct']>=m34['batch_consistent_event_drawdown_pct']-g['batch_event_drawdown_50_not_worse_than_34_by_more_than_percentage_points'],
